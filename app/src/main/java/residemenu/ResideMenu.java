...
import taska.ChangeLanguageTask;
import utility.Util;
...
//    private List<ResideMenuItem> rightMenuItems;
    ...
    private void initViews(Context context, int customLeftMenuId,
        ...
        listView= (ListView)scrollViewLeftMenu.findViewById(R.id.listView);
...
//
        ...
        new ChangeLanguageTask(context,listView, Util.changeLanguage(context)).execute();
    }
    ...
    protected boolean fitSystemWindows(Rect insets) {
        ...
        this.setPadding(viewActivity.getPaddingLeft() + insets.left,
                ...
                viewActivity.getPaddingRight() + insets.right,0);
